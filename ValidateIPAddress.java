...
IPv6 addresses are represented as eight groups of four hexadecimal digits, each group representing 16 bits. The groups are separated 
by colons (":"). For example, the address 2001:0db8:85a3:0000:0000:8a2e:0370:7334 is a valid one. Also, we could omit some leading 
...
class Solution {
    private boolean isIPv4(String IP) {
        ...
        for (String field : fields) {
            ...
            if (!String.valueOf(num).equals(field) || num < 0 || num > 255) { //判断和自己相不相等是为了判断前导0
                return false;
            }
        }
    ...
    public String validIPAddress(String IP) {
        ...
        if (isIPv6(IP.toUpperCase())) { //都变大写再传进去
            return "IPv6";
        }
