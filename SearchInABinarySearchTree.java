...
value. Return the subtree rooted with that node. If such node doesn't exist, you should return NULL.
...
class Solution {
    ...
    private TreeNode traversal(TreeNode root, int val) {
        ...
        TreeNode leftNode = traversal(root.left, val);
        ...
        TreeNode rightNode = traversal(root.right, val);
