...
subsequence is defined as the longest subsequence of one of these strings and this subsequence should not be any subsequence of the other 
strings.
...
class Solution {
    public int findLUSlength(String a, String b) {
        ...
        return a.equals(b)? -1 : Math.max(a.length(), b.length()); //a与b相等的话就不会有不公共的子串, 如果他俩不等, 谁最长谁肯定最不公共吖,
        //连长度都不一样, 咋还能公共
    }
}
